...
def like():
    ...
    and programming interfaces, for 1.file_structure_example distributions the current
...
def codename():
    ...
    1.file_structure_example, openSUSE returns "x86_64". This function does not handle such
...
def info(pretty=False, best=False):
    ...
    distribution in a dictionary, as shown in the following 1.file_structure_example:
